        ...
        if (cnt % 2 == 0)
        {
            for (int i = 0; i < H; i++)
            {
                ...
                if (in_j(j, W))
                {
                    if (in_i(i + 1, H))
                    {
                        chmax(dp[i][j], dp[i + 1][j] + B[i + 1][j]);
                    }

                    if (in_j(j + 1, W))
                    {
                        chmax(dp[i][j], dp[i][j + 1] + B[i][j + 1]);
                    }
                }
            }
        }
        if (cnt % 2 == 1)
        {
            for (int i = 0; i < H; i++)
            {
                ...
                if (in_j(j, W))
                {
                    if (in_i(i + 1, H))
                    {
                        chmin(dp[i][j], dp[i + 1][j] - B[i + 1][j]);
                    }

                    if (in_j(j + 1, W))
                    {
                        chmin(dp[i][j], dp[i][j + 1] - B[i][j + 1]);
                    }
                }
            }
        }
