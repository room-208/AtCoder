...
// 深さ優先探索
void DFS(const Graph_int &G, int v, long long x, const vector<int> &dist, vector<long long> &counter)
{
    ...
    for (auto next_v : G[v])
    {
        ...
        DFS(G, next_v, x, dist, counter); // 再帰的に探索
    }
