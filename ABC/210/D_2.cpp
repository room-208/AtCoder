...
struct Hara
{
    long long A;
    int i, j;
    Hara(int A, int i, int j) : A(A), i(i), j(j) {}
};
...
int main()
{
    ...
    vector<vector<long long>> min_1(H, vector<long long>(W,INF_ll));
    for (int i = 0; i < H; i++)
    {
        for (int j = 0; j < W; j++)
        {
            chmin(min_1[i][j],A[i][j]-C*(i+j));
            if(0<=i-1){
                chmin(min_1[i][j],min_1[i-1][j]);
            }
            if(0<=j-1)
            {
                chmin(min_1[i][j],min_1[i][j-1]);
            }
        }
    }
    for (int i = 0; i < H; i++)
    {
        for (int j = 0; j < W; j++)
        {
            ...
            if(0<=i-1){
                chmin(ans,tmp+min_1[i-1][j]);
            }
            if(0<=j-1)
            {
                chmin(ans,tmp+min_1[i][j-1]);
            }
        }
    }
    ...
    vector<vector<long long>> min_2(W, vector<long long>(H,INF_ll));
    for (int i = 0; i < W; i++)
    {
        for (int j = 0; j < H; j++)
        {
            chmin(min_2[i][j],B[i][j]-C*(i+j));
            if(0<=i-1){
                chmin(min_2[i][j],min_2[i-1][j]);
            }
            if(0<=j-1)
            {
                chmin(min_2[i][j],min_2[i][j-1]);
            }
        }
    }
    for (int i = 0; i < W; i++)
    {
        for (int j = 0; j < H; j++)
        {
            ...
            if(0<=i-1){
                chmin(ans,tmp+min_2[i-1][j]);
            }
            if(0<=j-1)
            {
                chmin(ans,tmp+min_2[i][j-1]);
            }
        }
    }
