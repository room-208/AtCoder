...
int main()
{
    ...
    for (int q = 0; q < Q; q++)
    {
        ...
        ///////////////////////////////////////////////////////////
        n = lower_bound(t.begin(), t.end(), x[q]) - t.begin();

        y = t[n];
        m = lower_bound(s.begin(), s.end(), y) - s.begin();
        chmin(ans, llabs(x[q] - y) + llabs(y - s[m]));
        chmin(ans, llabs(x[q] - y) + llabs(y - s[m - 1]));
        ...
        ///////////////////////////////////////////////////////////
        m = lower_bound(s.begin(), s.end(), x[q]) - s.begin();

        y = s[m];
        n = lower_bound(t.begin(), t.end(), y) - t.begin();
        chmin(ans, llabs(x[q] - y) + llabs(y - t[n]));
        chmin(ans, llabs(x[q] - y) + llabs(y - t[n - 1]));
