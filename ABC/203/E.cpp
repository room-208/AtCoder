...
int main()
{
    ...
    else
    {
        ...
        vector<long long> v_insert, v_erase;
        st.insert(N);
        int i = 0;
        long long x = S[i].x - 1;
        while (1)
        {
            ...
            while ((x + 1) == S[i].x)
            {
                if (st.count(S[i].y))
                {
                    v_erase.push_back(S[i].y);
                }
                if (st.count(S[i].y - 1))
                {
                    v_insert.push_back(S[i].y);
                }
                if (st.count(S[i].y + 1))
                {
                    v_insert.push_back(S[i].y);
            ...
            for (int j = 0; j < (int)v_erase.size(); j++)
            {
                st.erase(v_erase[j]);
            }
            for (int j = 0; j < (int)v_insert.size(); j++)
            {
                st.insert(v_insert[j]);
            }
