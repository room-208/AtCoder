...
int main()
{
    ...
    long long x_1 = -1, y_1 = -1;
    long long x_2 = -1, y_2 = INF_ll;
    long long x_3 = INF_ll, y_3 = -1;
    long long x_4 = INF_ll, y_4 = INF_ll;
    ...
    for (int i = 0; i < N; i++)
    {
        long long d_1 = min(llabs(x[i] - x_1), llabs(y[i] - y_1));
        long long d_2 = min(llabs(x[i] - x_2), llabs(y[i] - y_2));
        long long d_3 = min(llabs(x[i] - x_3), llabs(y[i] - y_3));
        long long d_4 = min(llabs(x[i] - x_4), llabs(y[i] - y_4));
