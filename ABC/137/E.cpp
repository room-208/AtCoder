...
//ベルマン・フォード法
vector<long long> Bellman_Ford(set<int> &st, const Graph_Edge &G, int s,
...
int main() {
  ...
  vector<long long> dist = Bellman_Ford(st, G, 0, exist_negative_cycle);
