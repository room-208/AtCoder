...
int main() {
  ...
  if (pow(10LL, 0) <= N && N < pow(10LL, 3) - 1LL) {
    cout << 0 << endl;
    return 0;
  }

  if (pow(10LL, 3) <= N && N < pow(10LL, 6) - 1LL) {
    ll cnt = 0;
    cnt += N - (pow(10LL, 3) - 1);
    cout << cnt << endl;
    return 0;
  ...
  if (pow(10LL, 6) <= N && N < pow(10LL, 9) - 1LL) {
    ll cnt = 0;
    cnt += N - (pow(10LL, 3) - 1);
    cnt += N - (pow(10LL, 6) - 1);
    cout << cnt << endl;
  ...
  if (pow(10LL, 9) <= N && N < pow(10LL, 12) - 1LL) {
    ll cnt = 0;
    cnt += N - (pow(10LL, 3) - 1);
    cnt += N - (pow(10LL, 6) - 1);
    cnt += N - (pow(10LL, 9) - 1);
  ...
  if (pow(10LL, 12) <= N && N < pow(10LL, 15) - 1LL) {
    ll cnt = 0;
    cnt += N - (pow(10LL, 3) - 1);
    cnt += N - (pow(10LL, 6) - 1);
    cnt += N - (pow(10LL, 9) - 1);
