...
// 深さ優先探索
void DFS(const Graph_int &G, int v, int p, vector<bool> &seen, vector<long long> &counter)
{
    ...
    for (auto next_v : G[v])
    {
        ...
        DFS(G, next_v, v, seen, counter); // 再帰的に探索
    }
