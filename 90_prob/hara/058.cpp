...
int main()
{
    ...
    {
        int a = u / 10000;
        int b = (u - 10000 * a) / 1000;
        int c = (u - 10000 * a - 1000 * b) / 100;
        int d = (u - 10000 * a - 1000 * b - 100 * c) / 10;
        int e = u - 10000 * a - 1000 * b - 100 * c - 10 * d;
