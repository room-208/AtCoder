...
using mint = modint1000000007; // static_modint<1000000009>;
...
int main()
{
    ...
    vector<vector<int>> cnt_yoko(H, vector<int>(W));
    for (int i = 0; i < H; i++)
    {
        for (int j = 0; j < W; j++)
        {
    ...
    vector<vector<int>> cnt_tate(H, vector<int>(W));
    for (int i = 0; i < H; i++)
    {
        for (int j = 0; j < W; j++)
        {
    ...
    for (int i = 0; i < H; i++)
    {
        for (int j = 0; j < W; j++)
        {
            cnt[i][j] = cnt_tate[i][j] + cnt_yoko[i][j] - 1;
        }
    }
